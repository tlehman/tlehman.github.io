...
\begin{tikzcd}[ampersand replacement=\&]
  \& F \arrow[dl, "\stackrel{\dagger}{=}_{FH}"'] \arrow[dr, "\stackrel{\dagger}{=}_{FS}"] \& \\
H \arrow[rr, "\stackrel{\dagger}{=}_{HS}"'] \arrow[ur, "\stackrel{\dagger}{=}_{HF}"] \& \& S \arrow[ul, "\stackrel{\dagger}{=}_{SF}"'] \arrow[ll, "\stackrel{\dagger}{=}_{SH}"]
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}[ampersand replacement=\&, column sep=large, row sep=large]
  \& \textcolor{red}{F} \arrow[dl, "\stackrel{\dagger}{=}_{FH}"'] \arrow[dr, "\stackrel{\dagger}{=}_{FS}"] \& \\
H \arrow[rr, "\stackrel{\dagger}{=}_{HS}"'] \arrow[ur, "\stackrel{\dagger}{=}_{HF}"] \& \& \textcolor{red}{S} \arrow[ul, "\stackrel{\dagger}{=}_{SF}"'] \arrow[ll, "\stackrel{\dagger}{=}_{SH}"]
\end{tikzcd}
\end{center}
...
\begin{center}
\begin{tikzcd}[ampersand replacement=\&, column sep=large, row sep=large]
  \& \textcolor{blue}{F} \arrow[dl, "\stackrel{\dagger}{=}_{FH}"'] \arrow[dr, "\stackrel{\dagger}{=}_{FS}"] \& \\
H \arrow[rr, "\stackrel{\dagger}{=}_{HS}"'] \arrow[ur, "\stackrel{\dagger}{=}_{HF}"] \& \& S \arrow[ul, "\stackrel{\dagger}{=}_{SF}"'] \arrow[ll, "\stackrel{\dagger}{=}_{SH}"]
\end{tikzcd}
\end{center}
